...
var Cell = function (_a) {
    ...
    return (React.createElement("td", { ref: rootRef, className: classNames("Spreadsheet__cell", data === null || data === void 0 ? void 0 : data.className, {
        ...
        }), onMouseOver: handleMouseOver, onMouseDown: handleMouseDown, tabIndex: 0, style: (data === null || data === void 0 ? void 0 : data.style) ? data.style : {}, rowSpan: (_b = data === null || data === void 0 ? void 0 : data.rowSpan) !== null && _b !== void 0 ? _b : 1, colSpan: (_c = data === null || data === void 0 ? void 0 : data.colSpan) !== null && _c !== void 0 ? _c : 1 },
...
var Spreadsheet = function (props) {
    var _a;
    var className = props.className, darkMode = props.darkMode, columnLabels = props.columnLabels, rowLabels = props.rowLabels, hideColumnIndicators = props.hideColumnIndicators, hideRowIndicators = props.hideRowIndicators, preventBlur = props.preventBlur, onKeyDown = props.onKeyDown, _b = props.Table, Table$1 = _b === void 0 ? Table : _b, _c = props.Row, Row$1 = _c === void 0 ? Row : _c, _d = props.HeaderRow, HeaderRow$1 = _d === void 0 ? HeaderRow : _d, _e = props.DataEditor, DataEditor$1 = _e === void 0 ? DataEditor : _e, _f = props.DataViewer, DataViewer$1 = _f === void 0 ? DataViewer : _f, _g = props.onChange, onChange = _g === void 0 ? function () { } : _g, _h = props.onModeChange, onModeChange = _h === void 0 ? function () { } : _h, _j = props.onSelect, onSelect = _j === void 0 ? function () { } : _j, _k = props.onActivate, onActivate = _k === void 0 ? function () { } : _k, _l = props.onBlur, onBlur = _l === void 0 ? function () { } : _l, _m = props.onCellCommit, onCellCommit = _m === void 0 ? function () { } : _m, _o = props.onEvaluatedDataChange, onEvaluatedDataChange = _o === void 0 ? function () { } : _o;
...
export { DataEditor, DataViewer, EmptySelection, EntireAxisSelection, EntireColumnsSelection, EntireRowsSelection, EntireSelection, EntireWorksheetSelection, InvalidIndexError, Model, PointRange, RangeSelection, Selection, Spreadsheet, createEmpty as createEmptyMatrix, createFormulaParser, Spreadsheet as default };
